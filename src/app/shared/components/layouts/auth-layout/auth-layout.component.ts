...
export class AuthLayoutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(locationArray.indexOf("signin") > -1 || locationArray.indexOf("signup") > -1 || locationArray.indexOf("forgot-password") > -1 || locationArray.indexOf("business-info") > -1  || locationArray.indexOf("reset-password") > -1 || locationArray.indexOf("password-reset-successful") > -1 || locationArray.indexOf("forgot-password-successful") > -1 || locationArray.indexOf("update-profile") > -1 || locationArray.indexOf("thank-you") > -1 || locationArray.indexOf("thank-you") > -1) {
