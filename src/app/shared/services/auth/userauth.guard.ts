...
export class UserAuthGuard implements CanActivate {
  ...
  canActivate(
    ...
    if ((this.userInfo.endUserType != '' && this.userUrlType != '' && this.userUrlType != 'subscription' && this.pageUrl && this.pageUrl != "signup"! && this.userUrlType != 'forgot-password' && this.userUrlType != 'signin' && this.userInfo.endUserType != this.userUrlType)) {// && this.pageUrl != 'update-profile'
